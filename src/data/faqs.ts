...
export const faqs = [
  {
    q: 'How does the Gamdom lossback rate actually get decided?',
    a: `The rate is negotiated case-by-case between Hugo and Gamdom's VIP operations desk, based primarily on your sustained monthly wager and the game-category mix (originals, slots, live tables and sportsbook each carry different blended playing edges). The Pro Tier sits at a 10% weekly lossback rate and corresponds to sustained monthly volume between $25,000 and $180,000. Above $180,000 of sustained monthly wager the conversation opens up to Elite Tier, where the rate is negotiable up to 20%. Hugo presents the volume case to the desk directly — you never have to argue your own number.`,
  },
  {
    q: 'Are my Gamdom sportsbook losses included in the calculation?',
    a: `Yes — this is one of the specific structural points Hugo negotiates upfront for managed Elite accounts. Gamdom runs casino and sportsbook on a unified wallet, which makes it operationally clean to blend losses from both verticals into a single weekly lossback calculation at the same headline percentage. Most public Gamdom reward structures keep these verticals on separate ledgers, so a single shared lossback rate across both is one of the meaningful structural upgrades the partner channel delivers — particularly for players running heavy parlay or live-betting volume.`,
  },
  {
    q: 'Do Gamdom originals (Crash, Mines, Plinko, Cups, Slot Battles) count?',
    a: `Yes. All Gamdom-proprietary originals count toward the net-loss calculation by default — Crash, Mines, Plinko, Cups, Slot Battles, Roulette and the rest. These tend to be where Elite clients concentrate the bulk of their volume because the playing edges are low and the round frequency is high, which produces an extremely clean net-loss curve over the weekly window. The provably-fair seed pairs Gamdom publishes after each round also mean the underlying numbers feeding the lossback calculation are independently auditable.`,
  },
  {
